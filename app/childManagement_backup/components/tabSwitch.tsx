...
const TableSwitch: React.FC<TableSwitchType> = ({
  ...
  return (
    <div className=" bg-white rounded-tr-2xl rounded-tl-2xl ">
      <div className=" flex justify-between gap-3 pt-8 pb-4 w-full px-10">
        <div
          className={`w-[30%] flex flex-row justify-between items-center pl-2 rounded-md cursor-pointer ${
            activeTab === "pending"
        ...
        >
          <div
            className={`flex w-2/5 px-4 justify-center items-center self-stretch border-r text-xl  ${
          ...
          >
            ...
            <div
              className={`text-2xl border-r-2 py-[19px]  ${
                activeTab === "pending"
                  ? "border-[#00858E]"
                  : "border-[#E1E1E1]"
              } `}
            ...
            <div className="flex flex-col justify-center items-center px-4 py-1 w-[7em]">
              ...
              <div className="text-[#00858E] font-[500]">
                {PendingData.length}
              </div>
            </div>
          </div>
        ...
        <div
          className={`w-[30%] pl-2 rounded-md flex flex-row justify-between items-center cursor-pointer ${
            activeTab === "waitlist"
              ? " border-2 border-[#00858E] "
              : "border-2 border-[#E1E1E1]"
          }`}
        ...
        <div
          ...
          onClick={() => handleTabClick("enrollmentWaitlist")}
        >
          <div
            className={`flex w-2/5 px-4 justify-center items-center self-stretch border-r text-xl  ${
              activeTab === "enrollmentWaitlist"
