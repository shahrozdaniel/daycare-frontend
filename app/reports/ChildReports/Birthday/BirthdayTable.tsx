...
interface BirthdayTableProps<TData, TValue> {
...
export function BirthdayTable<TData, TValue>({
  columns,
  data,
  selectedReport,
  selectedOption
}: BirthdayTableProps<TData, TValue>) {
    ...
    <>
      ...
      <div className="flex md:flex-col lg:flex-row justify-between">
        <div className="flex items-center md:py-2 lg:py-4">
          ...
          {selectedReport === 'Birthday' && selectedOption === 'Child Reports' && <>
            ...
            <div className="relative flex justify-center items-center">
              <Input
                ...
                placeholder="DOB : "
                value={
                  (table.getColumn("dateBirth")?.getFilterValue() as string) ?? ""
                }
                onChange={(event) =>
                  table.getColumn("dateBirth")?.setFilterValue(event.target.value)
                }
                className="md:w-[160px] lg:w-[220px] rounded-none ml-2 border-grey-border1 bg-grey-border1 text-grey-placeholder placeholder:text-grey-placeholder"
              />
            </div>
          </>}
        </div>
      ...
      <DataTable data={data} columns={columns} table={table}
        ...
        headerClassName="bg-[#EEFCFC] text-[#000000] text-[16px] font-medium font-sans"
